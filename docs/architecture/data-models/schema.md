...
`meal_service_logs` (ADR-195) and `stay_guardian_consent` (ADR-233) are all live in
...
| `stay_guardian_consent` | ADR-233 | `migrations/093_stay_guardian_consent.sql` | **No — not applied** |

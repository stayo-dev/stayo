...
- **Deliberately not built:** a separate owner↔tenant chat feature. The "chat message" case in the original ask (owner replying with a WiFi password, asking a follow-up) is the ticket-reply `note` above, not a new messaging system.

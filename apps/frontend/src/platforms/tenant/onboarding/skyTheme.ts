...
export function skyEnv(hour: number, override: ThemePhase | null): SkyEnv {
  ...
  if (phase === 'dusk') {
    return {
      phase,
      greeting,
      gradient: 'linear-gradient(180deg,#1a2240 0%,#3d4f7a 24%,#5572a8 42%,#7a98d4 52%,#a4bde8 62%,#d4e4f0 76%,#e8f1f8 100%)',
      flowGradient: 'linear-gradient(180deg,#1a2240 0%,#3d4f7a 13%,#5572a8 23%,#7a98d4 30%,#9db8e4 37%,#e8f1f8 44%,#e8f1f8 100%)',
      showSun: true,
      showMoon: false,
      sunTop: '92px',
      sunFill: 'radial-gradient(circle,#7a98d4,#5572a8)',
      sunGlow: '0 0 40px rgba(59,95,168,.4)',
      starOpacity: 0.25,
      cloudFill: 'rgba(122,152,212,.28)',
      cloudFill2: 'rgba(93,114,168,.22)',
      eyebrow: '#d4e4f0',
      title: '#fff',
      ...
      // Blue sky, text tinted light to stand out
      onSkyTitle: '#e8f1f8',
      onSkyBody: 'rgba(232,241,248,.82)',
      onSkyLabel: 'rgba(212,228,240,.78)',
      onSkyShadow: '0 1px 8px rgba(26,34,64,.35)',

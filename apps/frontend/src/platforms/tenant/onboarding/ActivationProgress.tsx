...
import { PANEL_INK } from './skyTheme';
  ...
  return (
    <div>
      <div className="flex items-center justify-between">
        <span className="font-display text-xs font-extrabold" style={{ color: PANEL_INK.active }}>
          Step {activeIdx + 1} of {nodes.length}
        </span>
        <span className="text-[11px] font-medium" style={{ color: PANEL_INK.muted }}>
          ...
          {nodes.map((node) => {
            ...
            return (
              ...
              >
                ...
                <span className="mt-[5px] text-center text-[9.5px] font-bold leading-[1.15]" style={{ color: active ? PANEL_INK.active : done ? PANEL_INK.done : PANEL_INK.pending }}>
                  {node.label}
                </span>
              </button>
            );

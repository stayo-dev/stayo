      ...
      <div className="mx-auto w-full max-w-md">
        <div className="relative z-[2] px-3 pb-2 pt-11">
          <div className="flex items-center gap-2.5 px-1 pb-3.5">
            <div className="relative flex h-[38px] w-[38px] flex-none items-center justify-center rounded-[11px]" style={{ background: '#B46A55', boxShadow: '0 4px 12px rgba(180,106,85,.4)' }}>
              <span className="font-display text-[23px] font-extrabold leading-none text-white">S</span>
              <div className="absolute bottom-2 left-1/2 grid -translate-x-1/2 grid-cols-2 grid-rows-2 gap-[1.4px]">
                <div className="h-[3px] w-[3px] rounded-[0.5px] bg-white" />
                <div className="h-[3px] w-[3px] rounded-[0.5px] bg-white" />
                <div className="h-[3px] w-[3px] rounded-[0.5px] bg-white" />
                <div className="h-[3px] w-[3px] rounded-[0.5px] bg-white" />
              </div>
            ...
            <div>
              ...
              <div className="mt-0.5 font-display text-base font-extrabold tracking-tight text-white">Stayo</div>
            </div>
          </div>

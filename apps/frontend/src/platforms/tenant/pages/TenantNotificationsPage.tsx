...
export function TenantNotificationsPage() {
  ...
  return (
    <div className="min-h-screen bg-background pb-10">
      {/*
        The console topbar already carries "Notifications" at lg+
        (`appHeaders.ts`'s `/tenant/notifications` entry) — this back+title
        row is mobile-only chrome from when this page had no shell around it.
      */}
      <div className="flex items-center gap-3 px-[22px] pb-4 pt-6 lg:hidden">
        <button
          type="button"
          aria-label="Back"
      ...
      <div className="lg:mx-auto lg:w-full lg:max-w-[640px] lg:px-0 lg:pt-8">
        {isLoading ? (
          <LoadingSkeleton />

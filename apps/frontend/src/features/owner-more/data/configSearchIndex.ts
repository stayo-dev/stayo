...
export const CONFIG_SEARCH_INDEX: ConfigSearchEntry[] = [
  { title: 'Rent rules', module: 'Finance', target: '/owner/more/configuration/finance/rent-schedule', keywords: 'rent generation due date billing cycle', glyph: '₹', tint: '#FBF1DE', iconColor: '#B8792B' },
  { title: 'Security deposit', module: 'Finance', target: '/owner/more/configuration/finance/deposit', keywords: 'deposit refund security', glyph: '₹', tint: '#FBF1DE', iconColor: '#B8792B' },
  ...
  { title: 'Refund policy', module: 'Hostel', target: '/owner/more/configuration/finance/deposit', keywords: 'refund deposit refundable policy', glyph: 'H', tint: '#F5E9E3', iconColor: '#B46A55' },

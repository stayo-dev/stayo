...
export const termsDocument: LegalDocument = {
  ...
  content: [
    ...
    },
    {
      ...
      number: 'A.1',
      text: 'What you are buying from us is software. Access to the Owner side of the Platform is provided on a subscription. The plan, price, billing cycle and what the plan includes are shown to you before you buy.',
    },
    {
      type: 'clause',
      id: 'clause-schedule-a-2',
      number: 'A.2',
      text: 'Where we offer a free trial, the length of the trial and what happens at the end of it are shown when you start it. Unless you cancel before the trial ends, the subscription continues as a paid subscription.',
    },
    {
      type: 'clause',
      id: 'clause-schedule-a-3',
      number: 'A.3',
      text: 'A subscription renews automatically at the start of each billing cycle, using the payment instrument you have authorised, until you cancel it.',
    },
    {
      type: 'clause',
      id: 'clause-schedule-a-4',
      number: 'A.4',
      text: 'If a subscription payment fails, we may retry it and we will tell you. If it stays unpaid, Owner features may be suspended. Suspension is not deletion: your data — your rooms, residents, obligations and records — is retained while the account is suspended, and access is restored when the subscription is brought up to date.',
    },
    {
      type: 'clause',

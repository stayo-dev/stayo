  ...
  content: [
    ...
    },
    {
      ...
      items: [
        ...
        'Authentication: a cloud identity provider that manages secure sign-in, session tokens and password resets, so we do not have to build or store password handling ourselves.',
        'Email delivery: a transactional email provider that sends receipts, account notifications and password-reset emails on our behalf.',
        ...
        'Messaging: a WhatsApp Business messaging provider used for one-time passwords, payment reminders and the platform’s WhatsApp commands.',

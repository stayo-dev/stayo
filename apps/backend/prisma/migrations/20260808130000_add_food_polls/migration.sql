...
CREATE INDEX "food_polls_hostel_id_status_idx" ON "food_polls"("hostel_id", "status");
CREATE UNIQUE INDEX "food_poll_options_poll_id_position_key" ON "food_poll_options"("poll_id", "position");
CREATE UNIQUE INDEX "food_poll_votes_poll_id_tenant_id_option_id_key" ON "food_poll_votes"("poll_id", "tenant_id", "option_id");
CREATE INDEX "food_poll_votes_poll_id_idx" ON "food_poll_votes"("poll_id");

...
/**
 * POST /api/platform-admin/subscriptions/[id]/pause
...
export async function POST(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    const result = await subscriptionAdminService.pause({
      subscriptionId: id,
    ...
    return subscriptionErrorResponse(error, "platform-admin.subscriptions.pause");
  }
}

...
function buildPolicyPatch(body: any) {
  return {
    billing: {
      deposit: { default_amount: body.advance_deposit },
      maintenance: { amount: body.maintenance_charge, type: body.maintenance_type },
      invite_defaults: { auto_fill_room_rent: body.auto_fill_room_rent, allow_override: body.allow_override },
    },
  };
}

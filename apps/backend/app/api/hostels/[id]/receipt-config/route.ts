...
function buildPolicyPatch(body: any) {
  return {
    receipts: { prefix: body.receipt_prefix, format: body.receipt_format, footer: body.receipt_footer, auto_email: body.auto_email_receipt },
    automation: { auto_email_receipts: body.auto_email_receipt },
  };
}

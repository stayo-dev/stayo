interface WhatsAppFABProps {
  ...
  ownerName: string;
  hostelName: string;
  whatsappFABTemplate?: string;
}

export function WhatsAppFAB({ whatsappNumber, ownerName, hostelName, whatsappFABTemplate }: WhatsAppFABProps) {
  const template = whatsappFABTemplate || "Hi {ownerName}, I'm interested in reserving a bed at {hostelName}";
      ...
      <style dangerouslySetInnerHTML={{__html: `
        @keyframes pulse-scale {
          ...
          50% {
            ...
            box-shadow: 0 20px 25px -5px rgba(37, 211, 102, 0.5), 0 10px 10px -5px rgba(37, 211, 102, 0.4);
          }
        }
